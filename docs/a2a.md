...
DrugClaw supports a lightweight agent-to-agent HTTP flow for instance-to-instance delegation.
...
Add an `a2a` section to `drugclaw.config.yaml`:
...
{
  "ok": true,
  "protocol_version": "drugclaw-a2a/v1",
  "agent_name": "Worker",
