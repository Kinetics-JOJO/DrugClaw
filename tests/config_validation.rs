...
use drugclaw::config::{Config, WorkingDirIsolation};
...
fn minimal_config() -> Config {
    Config {
        ...
        show_thinking: false,
        subagents: drugclaw::config::SubagentConfig::default(),
        a2a: drugclaw::config::A2AConfig::default(),
        ...
        web_fetch_validation:
            drugclaw_tools::web_content_validation::WebContentValidationConfig::default(),
        web_fetch_url_validation: drugclaw_tools::web_fetch::WebFetchUrlValidationConfig::default(),
        model_prices: vec![],
        ...
        soul_path: None,
        souls_dir: None,
        clawhub: drugclaw::config::ClawHubConfig::default(),
...
data_dir: /data/drugclaw
working_dir: /data/drugclaw/tmp
...
"#;
    ...
    assert_eq!(config.data_dir, "/data/drugclaw");
    assert_eq!(config.working_dir, "/data/drugclaw/tmp");
...
fn test_data_dir_paths() {
    ...
    config.data_dir = "/opt/drugclaw.data".into();
